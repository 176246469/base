...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'<input type="button" class="ke-button-common ke-button" value="全部清空" />',
			'</span><input type="hidden" id="start-button" value="开始" />',
			'</div>',
		...
		K('#start-button', self.div).click(function() {
...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage',
		...
		imageSizeLimit = K.undef(self.imageSizeLimit, '6MB'),
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png'),
		imageUploadLimit = K.undef(self.imageUploadLimit, 120),
